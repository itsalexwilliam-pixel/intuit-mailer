...
<div class="space-y-6">
    ...
    <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-lg font-semibold text-slate-900 dark:text-white">New Template</h2>
                <p class="text-sm text-slate-500 mt-0.5">Save a reusable email design for future campaigns.</p>
            </div>
        </div>
    </div>
